        ...
        <div class="card-body">
            <form method="post" class="row g-3">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <input class="form-control" type="text" name="supplier_name" required value="<?php echo sanitize($editItem['supplier_name'] ?? ''); ?>">
                </div>
                <div class="col-12 col-md-6">
                    <label class="form-label">Contact Info</label>
                    <input class="form-control" type="text" name="contact_info" value="<?php echo sanitize($editItem['contact_info'] ?? ''); ?>">
                </div>
                ...
                <tbody>
                    <?php foreach ($suppliers as $s): ?>
                        <tr>
                            ...
                            <td class="text-end">
                                <a class="btn btn-sm btn-outline-secondary" href="index.php?page=suppliers&edit=<?php echo $s['supplier_id']; ?>">Edit</a>
                                <a class="btn btn-sm btn-outline-danger" href="index.php?page=suppliers&delete=<?php echo $s['supplier_id']; ?>" onclick="return confirm('Delete supplier?');">Delete</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
